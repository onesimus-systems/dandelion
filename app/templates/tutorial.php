...
<div id="content">
    ...
    <p class="noindent">Welcome to the Dandelion Web Log. This brief tutorial will walk you through how to do all the basic tasks in Dandelion.</p>
