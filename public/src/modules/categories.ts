...
/* Use the Elm implementation instead */
/*                                    */
/**************************************/
...
function setDomID(id: string): void {
    domid = id;
}

function selectOnChange(elem: JQuery): void {
    // eslint-disable-next-line
    grabNextLevel(elem.value);
}
...
interface CategoryJSON {
    currentList: number[];
    levels: CategoryRender[][];
}

function renderSelectsFromJson(json: CategoryJSON): JQuery {
    ...
    for (const key in json.levels) {
        ...
        selectRender.change(function() { selectOnChange(this); });
...
function grabNextLevel(pid: string): void {
    ...
    $.get('/render/categoriesJson', { pastSelection: JSON.stringify(currentSelection) }, null, 'json')
        .done(function(json: CategoryJSON) {
            $(domid).replaceWith(renderSelectsFromJson(json));
        });
}

function grabFirstLevel(elemid: string): void {
...
function renderCategoriesFromString(str: string, elemid: string): void {
...
export default {
    ...
    grabFirstLevel,
    selectOnChange,
    renderSelectsFromJson,
    renderCategoriesFromString,
    createNew,
    editCat,
    deleteCat,
    getCatString,
